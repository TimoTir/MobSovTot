...
namespace MobSovAlytalo.Controllers
{
    public class SaunaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SaunaID,SaunaTila,SaunanNykyLampotila,SaunanNimi")] Sauna sauna)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SaunaID,SaunaTila,SaunanNykyLampotila,SaunanNimi")] Sauna sauna)
        {
            if (ModelState.IsValid)
            {
